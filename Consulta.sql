...
('Cinderela', '50505050505', 'cinderela@hotmail.com', 'Goiania', 'GO', NULL, NULL, NULL, null),
...
('Capitão Boeing', '11122233344', 'capitaoboeing@uol.com', 'Manaus', 'AM', NULL, NULL, NULL, null),
...
SELECT nomeCliente, email FROM cliente ORDER BY nomeCliente ASC 

/*Parte 11*/

SELECT nomeFuncionario, celular FROM funcionario ORDER BY nomeCliente ASC 
